package com.vcarpool.validation;
...
public class RegisterEmployeeModelValidation {
...
public boolean validate(RegisterEmployeeModel model) {
		...
		if(validString(model.getFirstName()) && validString(model.getLastName()) 
				&& validNumber(model.getEmployeeId()) &&   validEmail(model.getEmail())){
			result=true;
		}
